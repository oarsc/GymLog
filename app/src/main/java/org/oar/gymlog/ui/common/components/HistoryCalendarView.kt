...
import org.oar.gymlog.ui.common.dialogs.SelectMonthDialogFragment
import org.oar.gymlog.util.DateUtils.previousMonday
...
class HistoryCalendarView(context: Context, attrs: AttributeSet?) : FrameLayout(context, attrs) {
    ...
    private fun calculateFirstDay(): LocalDate {
        return firstDayOfMonth.withDayOfMonth(1).previousMonday()
    }
